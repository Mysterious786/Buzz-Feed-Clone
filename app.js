...
sourceLink.setAttribute('src','hhtps://www.unsplash.com');
...
unansweredQuestions.indexOf(questionId);
...
const showAnswer=()=>{
    ...
    const allAnswerBlock=documnet.querySelectorAll('.answer-block');
